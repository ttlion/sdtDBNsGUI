...
&emsp;:warning: **As the field "*sdtDBN being used*" states by displaying "*No file yet selected*", an sdtDBN must be learned ([first][1] or [second][2] tabs) before using this tab.** :warning:

...
- **As the field *dstDBN being used* states by displaying *No file yet selected*, an sdtDBN must be learned ([first][1] or [second][2] tabs) before using this tab.**
...
Besides showing directly in the GUI the graphical representation obtained for the sdtDBN, this graphical representation is also stored in a PNG file (named *imgNameExample.png* in the example of the previous image). This file is created in the same directory of the sdtDBN GUI program.
